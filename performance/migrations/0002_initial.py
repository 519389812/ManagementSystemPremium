...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='workloadposition',
            name='type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='workloadPosition_type', to='performance.positiontype', verbose_name='岗位类型'),
        ),
        migrations.AddField(
            model_name='workloaditem',
            name='position',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='workloadItem_position', to='performance.workloadposition', verbose_name='所属岗位'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='manhourrecord',
            name='position',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='manHourRecord_position', to='performance.manhourposition', verbose_name='岗位'),
        ),
        migrations.AddField(
            model_name='manhourrecord',
            name='user',
        ...
        migrations.AddField(
            model_name='manhourposition',
            name='type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='manHourPosition_type', to='performance.positiontype', verbose_name='岗位类型'),
        ),
        migrations.AddField(
            model_name='manhouritem',
            name='position',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='manHourItem_position', to='performance.manhourposition', verbose_name='所属岗位'),
        ),
