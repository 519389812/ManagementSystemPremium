...
class DowngradeRecord(models.Model):
    ...
    type = models.ForeignKey(FlightType, on_delete=models.CASCADE, verbose_name='航班类型')
    ...
    fill_user = models.ForeignKey(CustomUser, null=True, blank=True, on_delete=models.DO_NOTHING, verbose_name='经办人')
    ...
    review_user = models.ForeignKey(CustomUser, null=True, blank=True, on_delete=models.DO_NOTHING, verbose_name='审核人')
