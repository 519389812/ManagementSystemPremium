...
class DowngradeRecord(models.Model):
    ...
    type = models.ForeignKey(FlightType, on_delete=models.CASCADE, related_name='downgrade_flightType', verbose_name='航班类型')
    ...
    review_user = models.ForeignKey(CustomUser, null=True, blank=True, related_name='downgrade_review_user', on_delete=models.DO_NOTHING, verbose_name='审核人')
    ...
    supervisor_verify_user = models.ForeignKey(CustomUser, null=True, blank=True, related_name='downgrade_supervisor_verify_user', on_delete=models.DO_NOTHING, verbose_name='审核值班主任')
    ...
    manager_verify_user = models.ForeignKey(CustomUser, null=True, blank=True, related_name='downgrade_supervisor_verify_user', on_delete=models.DO_NOTHING, verbose_name='审核主任')
