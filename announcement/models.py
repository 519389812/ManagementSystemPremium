...
class Announcement(models.Model):
    ...
    people = models.ManyToManyField(CustomUser, related_name='announcement_people', blank=True, verbose_name='目标用户')
    ...
    repeat_number = models.IntegerField(null=True, blank=True, verbose_name='重复天数')
