    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sale_rule', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='rule.salerule', verbose_name='销量加成规则')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repeat_rule', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='rule.repeatrule', verbose_name='重复规则')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rule.penaltytype', verbose_name='处罚类别')),
            ],
            options={
                'verbose_name': '处罚',
